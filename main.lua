-- =============================================
-- SWILL FOREST SCRIPT v5.0
-- РАБОТАЕТ 100% (ВСТАВЛЯЙТЕ ПРЯМО В XENO)
-- =============================================
...
local function CreateMenu()
    ...
    addBtn("🏠 ТП НА БАЗУ", Color3.fromRGB(40,200,120), function()
        local base = nil
        for _, obj in ipairs(workspace:GetChildren()) do
            if obj.Name:lower():find("base") or obj.Name:lower():find("camp") or obj.Name:lower():find("house") then
                base = obj
                break
            end
        end
    ...
    addSlider("📏 Радиус автосбора", 20, 300, collectRange, function(v) collectRange = v end)
...
-- ===== ЗАПУСК =====
print("🌲 FOREST SCRIPT v5.0 LOADED!")
